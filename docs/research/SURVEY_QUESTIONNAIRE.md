...
This survey questionnaire is designed to evaluate the technical quality, usability, and operational acceptability of **FordaGO: Mobile-Based Gym Database Management System for AFFORDA Gym – Cabiao Branch** using the international standard **ISO/IEC 25010 Software Product Quality Model**.

Please evaluate the system based on your actual hands-on experience using the FordaGO mobile and web applications. Read each indicator carefully and indicate your level of agreement by placing a checkmark ($\checkmark$) in the appropriate column.
...
**Respondent Classification:** *(Please check one)*  
[ &nbsp; ] **IT Professional / Technical Expert**  
[ &nbsp; ] **Gym Administrator / Front-Desk Staff**  
[ &nbsp; ] **Certified Gym Coach / Personal Trainer**  
[ &nbsp; ] **Gym Member (End-User)**  

---

### **PART II: SYSTEM EVALUATION (ISO/IEC 25010 SOFTWARE QUALITY STANDARDS)**
...
Please provide any constructive feedback, suggestions, or recommendations for further enhancements of the **FordaGO** system:
...
<p align="center"><b>Thank you very much for your valuable time and participation in evaluating FordaGO!</b></p>
