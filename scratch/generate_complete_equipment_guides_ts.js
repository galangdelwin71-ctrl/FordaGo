...
const guideMapping = {
  9: { guide: 'guide_id9_vsquat.jpg', target: 'Quadriceps, Gluteus Maximus', desc: 'Pin-loaded lever V-squat with angled footplate and shoulder pads.' },
  10: { guide: 'shoulderPress.jpg', target: 'Anterior & Medial Deltoids, Triceps', desc: 'Star Trac overhead seated shoulder press machine.' },
  11: { guide: 'hipAbductor.jpg', target: 'Gluteus Medius, Outer Thighs', desc: 'Selectorized hip abductor & adductor swivel thigh machine.' },
  12: { guide: 'latPulldown.jpg', target: 'Latissimus Dorsi, Biceps', desc: 'Freemotion overhead wide grip lat pulldown station.' },
  13: { guide: 'seatedChestPress.jpg', target: 'Pectoralis Major, Front Delts', desc: 'Selectorized seated horizontal chest press machine.' },
  14: { guide: 'seatedCalfRaise.jpg', target: 'Soleus, Gastrocnemius', desc: 'Warrior Fitness plate-loaded seated calf raise machine.' },
  15: { guide: 'seatedChestPress.jpg', target: 'Upper Pectoralis, Anterior Delts', desc: 'Precor plate-loaded incline chest press machine.' },
  ...
  26: { guide: 'latPulldown.jpg', target: 'Latissimus Dorsi, Rhomboids', desc: 'Commercial plate-loaded iso-lateral lat pulldown machine.' },
  27: { guide: 'latPulldown.jpg', target: 'Latissimus Dorsi, Upper Back', desc: 'Plate-loaded iso-lateral high pulldown station.' },
  ...
  32: { guide: 'shoulderPress.jpg', target: 'Deltoid Group, Upper Trapezius', desc: 'Plate-loaded dual lever functional shoulder machine.' },
  33: { guide: 'seatedChestPress.jpg', target: 'Pectoralis Major, Anterior Delts', desc: 'Commercial iso-lateral plate-loaded flat/incline chest press.' },
  34: { guide: 'preacherCurl.jpg', target: 'Biceps Brachii, Brachialis', desc: 'Selectorized pin-stack seated bicep curl machine.' },
  35: { guide: 'seatedChestPress.jpg', target: 'Pectoralis Major, Triceps', desc: 'Selectorized pin-loaded seated chest press machine.' },
  36: { guide: 'seatedChestPress.jpg', target: 'Upper & Mid Pectorals', desc: 'Multi-position commercial adjustable workout bench.' },
  ...
  40: { guide: 'shoulderPress.jpg', target: 'Anterior & Medial Deltoids', desc: 'Selectorized shoulder press machine with dual grip handles.' },
  ...
  46: { guide: 'latPulldown.jpg', target: 'Latissimus Dorsi, Biceps', desc: 'Star Trac Instinct high lat pulldown machine.' },
  47: { guide: 'guide_id47_ezbar_curl.jpg', target: 'Biceps Brachii, Forearms', desc: 'Barbell rack with fixed-weight EZ curl barbells.' },
  48: { guide: 'seatedChestPress.jpg', target: 'Pectoralis Major, Anterior Deltoids', desc: 'Star Trac Instinct seated chest press machine.' },
  ...
  50: { guide: 'shoulderPress.jpg', target: 'Anterior & Medial Deltoids, Triceps', desc: 'Star Trac Instinct seated shoulder press machine.' },
  51: { guide: 'legExtension.jpg', target: 'Quadriceps, Calves', desc: 'Freemotion cable dual leg extension / calf machine.' },
  52: { guide: 'seatedChestPress.jpg', target: 'Pectoralis Major', desc: 'Star Trac Instinct horizontal bench chest press machine.' },
...
console.log('Successfully generated full compatibility equipment-guides.data.ts!');
